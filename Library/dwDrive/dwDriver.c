...
//Display time use picture
//void funDisTime(u16 timing){
//	dwCutPic(7, 0+(timing/600)*24, 0, 24+(timing/600)*24, 35, 182, 218);
//	dwCutPic(7, 0+(timing/60%10)*24, 0, 24+(timing/60%10)*24, 35, 206, 218);
//	dwCutPic(7, 242, 9, 246, 24, 240, 227);
//	dwCutPic(7, 0+(timing%60/10)*24, 0, 24+(timing%60/10)*24, 35, 254, 218);
//	dwCutPic(7, 0+(timing%10)*24, 0, 24+(timing%10)*24, 35, 278, 218);
//}

//Display time use System char
void funDisTime(u16 timing){
	dwDisNum(DW_SIZE_48, 85,    42,timing/600);
	dwDisNum(DW_SIZE_48, 85+24, 42,timing/60%10);
	dwDisChar(DW_SIZE_48,85+48, 42,':');
	dwDisNum(DW_SIZE_48, 85+72, 42,timing%60/10);
	dwDisNum(DW_SIZE_48, 85+96, 42,timing%10);
}
...
display number 
value:dis value
CharNum:dis char number(max 10 for DEC, 8 for hex)
