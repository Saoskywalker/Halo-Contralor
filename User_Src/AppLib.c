...
//distinguish command
static const u8 DistInit[] = {0XA0, 0XA0, 0XA0}; //model Init
static const u8 DistInitRe[] = {0X50, 0X50, 0X16};
static u8 DistGroup[] = {0XA9, 0X01, 0X00}; //Select group
static u8 DistGroupRe[] = {0X59, 0X01, 0X00};
static u8 DistStartOnce[] = {0XAA, 0X0A, 0X00}; //start once work
